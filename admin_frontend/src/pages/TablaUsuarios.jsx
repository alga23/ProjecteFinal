...
export default function TablaUsuarios() {
    ...
    return (
        <section className='interaccion-user'>
            <header className='cabecera-interaccion'>
                ...
                {selectedItems.length >= 2 && (
                    <button className='eliminar-usuario'><FontAwesomeIcon icon={faMinus} /> Eliminar usuario</button>
                )}
                <button className='añadir-usuario'><FontAwesomeIcon icon={faPlus} /> Añadir usuario</button>
                </div>
